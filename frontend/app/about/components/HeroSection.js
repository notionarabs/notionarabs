            ...
            <div className="container-custom relative z-10 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    >
                        ...
                        <motion.h1
                            className="text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-black tracking-tighter mb-8 text-accent-500 dark:text-white leading-[1.15] overflow-visible"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        <motion.p
                            className="text-base sm:text-lg text-accent-600 dark:text-dark-text-secondary leading-relaxed mb-8 max-w-xl font-medium"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.4, duration: 0.6 }}
                        >
                            عرب نوشن (Notion Arabs) هي الوجهة والمجتمع الإقليمي الأول المتخصص في تمكين المبدعين وصناع المحتوى العرب. نحن نوفر أرقى القوالب الاحترافية، الأدوات الذكية، والخبرات التقنية التي تساعدك على تحويل نوشن إلى نظام متكامل للإبداع والنمو الشخصي والمهني في العالم العربي.
                        </motion.p>
                    </motion.div>
