            ...
            <div className="container-custom relative z-10 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    >
                        ...
                        >
                            عرب نوشن (Notion Arabs) هي المنصة والمجتمع الأول عربياً المتخصص في توفير أرقى قوالب نوشن الرقمية والأدوات المبتكرة. نحن نؤمن بأن التنظيم هو مفتاح الإبداع، ولذلك نسعى لتمكين المستخدم العربي من بناء مساحات عمل ذكية تساعده على التركيز، الإنتاجية، والنمو.
                        </motion.p>
                    </motion.div>
