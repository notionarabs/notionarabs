            ...
            <div className="container-custom relative z-10 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    >
                        ...
                        >
                            عرب نوشن (Notion Arabs) هي المنصة والشركة الأولى عربياً المتخصصة في تقديم الاستشارات، أتمتة الأعمال، وتوفير قوالب نوشن احترافية للشركات والأفراد. نبني نظام عمل متكامل يساعدك تبني عمليات واضحة، وتتعلم أسرع، وتكبر شغلك بثقة.
                        </motion.p>
                    </motion.div>
