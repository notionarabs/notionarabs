              ...
              <div className="mt-8 space-y-4">
                ...
                {creator.showEmail && creator.email && (
                  <div className="flex items-center gap-3 justify-center md:justify-start">
                    ...
                    <a href={`mailto:${creator.email}`} className="text-accent-600 dark:text-dark-text-secondary hover:text-primary-500 dark:hover:text-orange-400 transition-colors">
                      {creator.email}
                    </a>
                  </div>
                )}
                ...
                {creator.showPhone && creator.phone && (
                  <div className="flex items-center gap-3 justify-center md:justify-start">
                    ...
                    <a href={`tel:${creator.phone}`} className="text-accent-600 dark:text-dark-text-secondary hover:text-primary-500 dark:hover:text-orange-400 transition-colors">
                      {creator.phone}
                    </a>
                  </div>
                )}
