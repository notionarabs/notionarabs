              ...
              {creator.socialLinks.map((link, index) => {
                ...
                return (
                  <a
                    ...
                    className={`flex items-center gap-3 px-6 py-3 rounded-xl transition-all duration-200 hover:scale-105 shadow-soft hover:shadow-medium ${platform ? getPlatformStyles(platform.name) : 'bg-gray-100 dark:bg-dark-tertiary hover:bg-gray-200 dark:hover:bg-dark-quaternary'
                      }`}
                  >
                    {platform ? (
