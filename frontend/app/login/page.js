  ...
  return (
    ...
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden" dir="rtl">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Animated Blobs */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-primary-400/20 rounded-full blur-3xl opacity-30 animate-pulse mix-blend-multiply dark:mix-blend-screen transform translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-accent-400/20 rounded-full blur-3xl opacity-30 animate-pulse mix-blend-multiply dark:mix-blend-screen transform -translate-x-1/2 translate-y-1/2" style={{ animationDelay: '1s' }}></div>
      </div>
