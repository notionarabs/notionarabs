...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-secondary-50 dark:bg-dark-primary text-accent-500 dark:text-dark-text-primary transition-colors duration-300" dir="rtl">
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="text-center">
            <div className="max-w-4xl mx-auto">
              ...
              {/* Notion Service Specialist — Credly Verified Badge */}
              <div className={`flex items-center justify-center ${!animationsPlayed ? 'text-reveal-delayed-3' : ''}`} style={{ animationDelay: '1.1s' }}>
                <a
                ...
                >
                  <img
                    ...
                    alt="Notion Service Specialist Certified"
                    className="w-16 h-16 object-contain drop-shadow-md transition-transform duration-300 group-hover:scale-110"
                  />
                  <span className="text-[10px] font-semibold tracking-widest uppercase text-accent-400 dark:text-white/40 group-hover:text-primary-500 dark:group-hover:text-orange-400 transition-colors duration-200">
                    Verify on Credly ↗
                  </span>
                </a>
              </div>
      ...
      {/* Notion Service Specialist Certification Section */}
      <section className="section-reveal py-12 sm:py-16 md:py-20 lg:py-24 bg-white dark:bg-dark-secondary transition-colors duration-300" data-reveal-section>
        <div className="container-custom">
