...
const pressReleases = [
  {
    id: 1,
    title: "عرب نوشن تطلق منصتها الجديدة لبيع وشراء قوالب نوشن",
    date: "2024-01-15",
    summary: "أعلنت شركة عرب نوشن عن إطلاق منصتها الجديدة المتخصصة في بيع وشراء قوالب نوشن باللغة العربية",
