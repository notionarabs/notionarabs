    ...
    <div className="min-h-screen bg-secondary-50 dark:bg-dark-primary transition-colors duration-300" dir="rtl">
      ...
      <div className="container-custom py-12 sm:py-16">
        ...
        <div className="card p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-xl border-0 bg-white/80 dark:bg-dark-card-bg/80 backdrop-blur-sm relative mx-4 sm:mx-0">
          ...
          <Link href="/settings" className="absolute top-3 left-3 sm:top-4 sm:left-4 p-2 rounded-lg sm:rounded-xl bg-gray-100 dark:bg-dark-tertiary hover:bg-gray-200 dark:hover:bg-dark-primary transition-colors duration-200 group">
