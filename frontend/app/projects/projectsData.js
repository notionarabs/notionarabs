export const projects = [
    {
        ...
        tags: ['تطوير ويب', 'Notion API', 'Full-Stack'],
        ...
        meta: [
            { label: 'العميل', value: 'YuYan Academy' },
            { label: 'نوع الحل', value: 'Waitlist System' },
            { label: 'التقنيات', value: 'Next.js · Node.js · MongoDB · Notion API' },
        ],
        content: `تم تطوير هذا المشروع كحل تقني عاجل لأكاديمية **YuYan** لجمع وإدارة بيانات الطلاب المهتمين بالانضمام للدورات لغات القادمة، وذلك من خلال صفحة هبوط (Landing Page) ذكية تعمل كقائمة انتظار (Waitlist).
