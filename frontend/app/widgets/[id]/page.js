...
const WIDGET_SEO = {
    ...
    prayer: {
        title: 'ودجت مواقيت الصلاة - رَمَضان 1447',
        description: 'ودجت نوشن مجاني يعرض مواقيت الصلاة الخمس والتاريخ الهجري لمدينتك تلقائياً. مفعل حالياً لموسم رمضان ١٤٤٧.',
        keywords: [
            'مواقيت الصلاة نوشن',
