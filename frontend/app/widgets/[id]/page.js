...
const WIDGET_SEO = {
    ...
    'small-deeds': {
        title: 'ودجت متتبع السنن والرواتب لنوشن - Small Deeds Tracker',
        description: 'ودجت نوشن مجاني لتتبع السنن الرواتب، الأذكار، وورد القرآن اليومي. حافظ على عبادتك بتصميم إسلامي عصري وأنيق.',
        keywords: [
            'متتبع السنن نوشن',
            'small deeds tracker notion',
            'السنن الرواتب نوشن',
            'أذكار الصباح والمساء نوشن',
            'تتبع العبادات نوشن',
            'ودجت إسلامي نوشن',
