/**
 * Metadata for the Hadith widget embed page.
...
export const metadata = {
    ...
    alternates: {
        types: {
            'application/json+oembed': `${siteConfig.url}/api/oembed?url=${siteConfig.url}/widgets/hadith/embed`,
        },
    },
};

export default function HadithEmbedLayout({ children }) {
    return children;
}
