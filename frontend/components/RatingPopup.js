...
export default function RatingPopup({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-dark-secondary rounded-2xl shadow-2xl max-w-xl w-full transform transition-all duration-300 scale-100 opacity-100">
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-gray-200 dark:border-dark-card-border">
          <div>
            <h3 className="text-lg font-bold text-accent-900 dark:text-dark-text-primary">
              قيم هذا القالب وشاركنا رأيك
            </h3>
            <p className="text-sm text-accent-600 dark:text-dark-text-secondary mt-0.5">
        ...
        {/* Template Info */}
        <div className="p-5 border-b border-gray-200 dark:border-dark-card-border">
        ...
        <div className="p-5">
          ...
          {isTemplateCreator && (
            <div className="text-center py-6">
              ...
              <h4 className="text-base font-semibold text-accent-900 dark:text-dark-text-primary mb-1">
        ...
        {/* Compact Join Community Section */}
        <div className="px-5 pb-5 pt-0">
          <div className="pt-4 border-t border-gray-200 dark:border-dark-card-border flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-600 hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/30 rounded-lg transition-colors text-xs font-medium"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-500 hover:bg-blue-100 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/30 rounded-lg transition-colors text-xs font-medium"
              >
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
