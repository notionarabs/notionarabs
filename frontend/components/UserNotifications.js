  ...
  return (
    <div className="relative notifications-dropdown" dir="rtl" ref={containerRef}>
      <button
        ...
        className="relative p-2.5 rounded-xl hover:bg-primary/5 dark:hover:bg-white/10 transition focus:outline-none focus:ring-2 focus:ring-orange-400/60 h-11 w-11 flex items-center justify-center"
        aria-label="الإشعارات"
      >
        <svg className="w-6 h-6 drop-shadow-sm text-primary-500 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
