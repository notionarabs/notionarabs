  ...
  return (
    <div className="relative notifications-dropdown" dir="rtl" ref={containerRef}>
      <button
        ...
        className="relative p-2 rounded-xl hover:bg-white/10 dark:hover:bg-white/10 transition focus:outline-none focus:ring-2 focus:ring-orange-400/60"
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-gradient-to-r from-orange-500 to-amber-400 text-white text-[10px] leading-none rounded-full px-1.5 py-0.5 shadow-md">
            {unreadCount}
          </span>
        )}
      </button>
