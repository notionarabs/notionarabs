export default function PreferencesSection({
    ...
    return (
        <div className="space-y-6 lg:space-y-8">
            {/* Privacy Settings (Only for Creators) */}
            {isCreator && (
                <div className="bg-white dark:bg-dark-secondary border-none rounded-2xl shadow-sm overflow-hidden">
                    <div className="p-6 lg:p-8 bg-gray-50/50 dark:bg-dark-tertiary/20 border-none">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-dark-text-primary">الخصوصية وإعدادات الملف</h2>
                    </div>
                    <div className="p-6 lg:p-8 space-y-6">
                        <div className="flex items-center justify-between p-4 bg-gray-50/50 dark:bg-dark-tertiary/20 rounded-2xl border-none shadow-sm">
                            <div>
                                ...
                                <p className="text-xs font-medium text-gray-500 dark:text-dark-text-secondary mt-1">تلقي رسائل واستفسارات من المستخدمين</p>
                            </div>
                        ...
                        {profileSettings.allowMessages && (
                            <div className="space-y-2">
                                <label className="text-sm font-black text-gray-900 dark:text-dark-text-primary">بريد التواصل العام</label>
                                <input
                                    type="email"
                        ...
                        <div className="flex items-center justify-between p-4 bg-gray-50/50 dark:bg-dark-tertiary/20 rounded-2xl border-none shadow-sm">
                            <div>
                                ...
                                <p className="text-xs font-medium text-gray-500 dark:text-dark-text-secondary mt-1">إظهار إجمالي قوالبك في ملفك العام</p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer" dir="ltr">
                                <input
                                    type="checkbox"
