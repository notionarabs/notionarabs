...
export default function PrayerWidget({
    ...
    return (
        <div className={`w-full p-6 md:p-8 rounded-[2.5rem] transition-all duration-500 relative group overflow-hidden ${fontClasses[font]} ${theme === 'dark' ? 'bg-[#191919] text-white border border-[#2f2f2f]' : 'bg-white text-accent-900 border border-gray-100 shadow-xl'
            }`}>
