...
const nextConfig = {
  ...
  async headers() {
    const cspNonEmbed = [
      ...
      `connect-src 'self' https://api.notionarabs.com https://notionarabs.com https://api.brevo.com https://www.google-analytics.com https://www.googletagmanager.com https://api.alquran.cloud https://everyayah.com https://cdn.islamic.network https://cdn.alquran.cloud https://server8.mp3quran.net https://server6.mp3quran.net https://server7.mp3quran.net https://server10.mp3quran.net https://server12.mp3quran.net https://download.quranicaudio.com https://cdn.jsdelivr.net https://assets.mixkit.co https://api.open-meteo.com https://nominatim.openstreetmap.org${devConnectSrc}`,
